...
:file: algcover_test.py
:author: Yusuke Matsunaga (松永 裕介)
:copyright: Copyright (C) 2025 Yusuke Matsunaga, All rights reserved.
"""

import pytest
from ymlogic import AlgCover, AlgCube, Literal
...
def test_construct2():
    ...
    cube1 = AlgCube(ni, literal_list=[lit0, ~lit1])
    cube2 = AlgCube(ni, literal_list=[lit2, ~lit3])

    cover1 = AlgCover(ni, cube_list=[cube1, cube2])
...
def test_construct2_bad():
    ...
    cube1 = AlgCube(ni, literal_list=[lit0, ~lit1])
    cube2 = AlgCube(ni + 1, literal_list=[lit2, ~lit3])
...
def test_construct3():
    ...
    cover1 = AlgCover(ni, cube_list=[[lit0, ~lit1], [lit2, ~lit3]])
...
def test_cover_cover_sum():
    ...
    cover1 = AlgCover(ni, cube_list=[cube1])
    cover2 = AlgCover(ni, cube_list=[cube1, cube2])
...
def test_cover_cover_sum_bad():
    ...
    cover1 = AlgCover(ni, cube_list=[[lit0, ~lit1]])
    cover2 = AlgCover(ni + 1, cube_list=[[lit2, ~lit3]])
...
def test_cube_cover_sum():
    ...
    cover2 = AlgCover(ni, cube_list=[cube2])
...
def test_cube_cover_sum_bad():
    ...
    cube1 = AlgCube(ni + 1, literal_list=[lit0, ~lit1])
    cube2 = AlgCube(ni, literal_list=[lit2, ~lit3])
...
def test_cover_cover_diff():
    ...
    src1 = AlgCover(ni, cube_list=[[lit0, lit1], [lit2, lit3]])
    src2 = AlgCover(ni, cube_list=[[lit3, lit2], [lit0, ~lit1]])
...
def test_cover_cover_diff_bad():
    ...
    src1 = AlgCover(ni, cube_list=[[lit0, lit1], [lit2, lit3]])
    src2 = AlgCover(ni + 1, cube_list=[[lit3, lit2], [lit0, ~lit1]])
...
def test_cover_cube_diff():
    ...
    src1 = AlgCover(ni, cube_list=[[lit0, lit1], [lit2, lit3]])
    src2 = AlgCube(ni, literal_list=[lit3, lit2])
...
def test_cover_cube_diff_bad():
    ...
    src1 = AlgCover(ni, cube_list=[[lit0, lit1], [lit2, lit3]])
    src2 = AlgCube(ni + 1, literal_list=[lit3, lit2])
...
def test_cover_cover_product():
    ...
    src1 = AlgCover(ni, cube_list=[[lit0], [lit1]])
    src2 = AlgCover(ni, cube_list=[[lit2], [lit3]])
...
def test_cover_cover_product_bad():
    ...
    src1 = AlgCover(ni, cube_list=[[lit0], [lit1]])
    src2 = AlgCover(ni + 1, cube_list=[[lit2], [lit3]])
...
def test_cover_cube_product():
    ...
    src1 = AlgCover(ni, cube_list=[[lit0], [lit1]])
    src2 = AlgCube(ni, literal_list=[lit2])
...
def test_cover_cube_product_bad():
    ...
    src1 = AlgCover(ni, cube_list=[[lit0], [lit1]])
    src2 = AlgCube(ni + 1, literal_list=[lit2])
...
def test_cover_cover_quotient():
    ...
    src1 = AlgCover(ni, cube_list=[[lit0, lit2],
                                   [lit0, lit3],
                                   [lit1, lit2],
                                   [lit1, lit3]])
    src2 = AlgCover(ni, cube_list=[[lit0],
                                   [lit1]])
...
def test_cover_cover_quotient_bad():
    ...
    src1 = AlgCover(ni, cube_list=[[lit0, lit2],
                                   ...
                                   [lit1, lit2],
                                   [lit1, lit3]])
    src2 = AlgCover(ni + 1, cube_list=[[lit0],
                                   [lit1]])
...
def test_cover_cover_quotient_int():
    ...
    cover1 = AlgCover(ni, cube_list=[[lit0, lit2],
                                     [lit0, lit3],
                                     [lit1, lit2],
                                     [lit1, lit3]])
    src2 = AlgCover(ni, cube_list=[[lit0],
...
def test_cover_cube_quotient():
    ...
    src1 = AlgCover(ni, cube_list=[[lit0, lit2],
                                   ...
                                   [lit1, lit2],
                                   [lit1, lit3]])
    src2 = AlgCube(ni, literal_list=[lit0])
...
def test_cover_cube_quotient_bad():
    ...
    src1 = AlgCover(ni, cube_list=[[lit0, lit2],
                                   ...
                                   [lit1, lit2],
                                   [lit1, lit3]])
    src2 = AlgCube(ni + 1, literal_list=[lit0])
...
def test_to_expr():
    ...
    cover1 = AlgCover(ni, cube_list=[[lit0, lit1], [~lit2]])
