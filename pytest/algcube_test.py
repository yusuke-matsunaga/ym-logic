...
:file: algcube_test.py
:author: Yusuke Matsunaga (松永 裕介)
:copyright: Copyright (C) 2025 Yusuke Matsunaga, All rights reserved.
"""

import pytest
from ymlogic import AlgCube, Literal
...
def test_constructor2():
    ...
    lit_list = [lit]
    cube = AlgCube(ni, literal_list=lit_list)
...
def test_constructor3():
    ...
    cube = AlgCube(ni, literal_list=src_lit_list)
...
def test_check_containment():
    ...
    cube1 = AlgCube(ni, literal_list=src_lit_list)

    cube2 = AlgCube(ni, literal_list=[lit1])

    assert cube1.check_containment(cube2)
    assert not cube2.check_containment(cube1)

    cube3 = AlgCube(ni, literal_list=[lit2])
...
def test_check_containment_bad():
    ...
    cube2 = AlgCube(ni + 1, literal_list=[lit1])
...
def test_cube_product2():
    ...
    cube1 = AlgCube(ni, literal_list=[lit2, lit3])
    cube2 = AlgCube(ni, literal_list=[lit1, lit4])
...
def test_cube_cube_quotient1():
    ...
    cube1 = AlgCube(ni, literal_list=[lit1, lit2, lit3])
    cube2 = AlgCube(ni, literal_list=[lit1, lit3])
...
def test_cube_cube_quotient2():
    ...
    cube1 = AlgCube(ni, literal_list=[lit1, lit2])
    cube2 = AlgCube(ni, literal_list=[lit3])
...
def test_compare1():
    ...
    cube2 = AlgCube(ni, literal_list=[ lit0, ~lit1])
...
def test_compare_bad():
    ...
    cube1 = AlgCube(ni, literal_list=[ lit0,  lit1])
    cube2 = AlgCube(ni + 1, literal_list=[ lit0, ~lit1])
