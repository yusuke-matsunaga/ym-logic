...
TEST(AlgCoverTest, Rcover_cover_sum)
{
  const int nv = 10;
...
TEST(AlgCoverTest, cover_Rcover_sum)
{
  const int nv = 10;
...
TEST(AlgCoverTest, Rcover_Rcover_sum)
{
  const int nv = 10;
  ...
  AlgCover cover1 = std::move(src1) + std::move(src2);
...
TEST(AlgCoverTest, Rcover_cube_sum)
{
  const int nv = 10;
...
TEST(AlgCoverTest, cube_Rcover_sum)
{
  const int nv = 10;
